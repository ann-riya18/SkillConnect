...
export default function PendingRequests() {
  ...
  const fetchPending = async () => {
    try {
      ...
      const msg = err?.response?.data?.detail || "Failed to load pending skills.";
      setError(msg);
  ...
  const navigationItems = [
    { name: "Pending Requests", icon: Clock, path: "/admin/pending", active: true },
      ...
      <div className="flex">
            ...
            {navigationItems.map((item) => (
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition group ${item.active
                  ? "bg-purple-900 bg-opacity-20 text-purple-400 border border-purple-800"
        ...
        <main className="flex-1 p-6 lg:p-8">
          <div className="max-w-7xl mx-auto">
            <div className="mb-8 flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-400">
                  Review and manage incoming skill submissions
                </p>
              </div>
              <button
            ...
            {loading ? (
              <div className="text-gray-400 text-center py-12">Loading pending skills...</div>
            ) : error ? (
              ...
              <div className="bg-gray-900 border border-gray-800 rounded-xl p-12 text-center text-gray-400">
                ...
                <p className="text-sm mt-2">All caught up! New submissions will appear here.</p>
              </div>
            ) : (
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                      ...
                      <div className="flex-1">
                        <div className="flex items-start justify-between">
                          <div>
                            <span className="px-2 py-1 bg-yellow-900 bg-opacity-30 text-yellow-400 text-xs rounded-full border border-yellow-800 mb-2 inline-block">
                              Pending Review
                            </span>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <button
                            ...
                            className="px-4 py-2 border border-red-600 text-red-400 rounded-lg hover:bg-red-900 hover:bg-opacity-20 transition"
                          >
                            Decline
                          </button>
                          <button
